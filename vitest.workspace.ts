 ...
 * Vitest projects:
 *
 *   - `vue-3.5` / `vue-3.3` — same `vScrollIntoView.test.ts` and
 *     `playground.smoke.test.ts` run against two Vue minor versions
 *     (default `^3.5.0` and the aliased `vue3_3@3.3.13`) to prove the
 *     directive's public API surface is portable across the supported
