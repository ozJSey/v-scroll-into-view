...
- [Pairing with `focus()`](https://ozjsey.github.io/npm-portfolio-playground/#v-scroll-into-view/focus) — the browser's own focus scroll is synchronous and lands first, so the two disagree by more than 80px until you pass `preventScroll: true`
